-- Deploy mycryptofolio:alter_functions to pg
...
SELECT
	...
	transaction.price_btc,
	transaction.price_eth
FROM transaction
JOIN wallet
...
CREATE OR REPLACE FUNCTION add_transaction(json) RETURNS transaction AS $$
	INSERT INTO transaction (buy_date, buy, price, quantity, wallet_id, crypto_id, fiat, price_eur, price_eth, price_btc, price_usd)
	VALUES (
