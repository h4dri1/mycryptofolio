...
import {
  Typography, Grid, Box, ToggleButton, ToggleButtonGroup, Chip,
} from '@mui/material';
...
import { fetchChartData } from '../../actions/cryptoDetails';
...
function CryptoDetails() {
  ...
  const currentPrice = data.market_data ? currency(data.market_data.current_price[selectedCurrency.toLowerCase()], selectedCurrency) : 0;
    ...
    <>
      ...
      >
        <Grid
          container
          sx={{
            justifyContent: 'center', display: 'flex', gridAutoFlow: 'row', flexDirection: 'row', flexWrap: 'wrap',
          }}
        >
          <Box
            xs={11}
            sx={{
              backgroundColor: 'primary.main', flex: 2, marginLeft: { xs: 1, lg: 1, xl: 6.5 }, marginRight: { xs: 1, lg: 1, xl: 6.5 }, boxShadow: 4, borderRadius: '10px', padding: 2, minWidth: '55%',
            }}
          >
            <Box sx={{
              justifyContent: { xs: 'center', lg: 'space-between', xl: 'space-between' }, display: 'flex', flexWrap: 'wrap', marginTop: { xs: 0, lg: 2, xl: 2 }, marginBottom: 2,
            }}
            >
              <Box sx={{ marginBottom: { xs: 1 }, display: 'flex' }}>
                <Typography sx={{ fontSize: '1.5rem', color: 'secondary.light', mr: 1 }}>{currentPrice}</Typography>
          ...
          <Box
            ...
            sx={{
              ...
              borderRadius: '10px',
              padding: 2,
              marginRight: { xs: 1, lg: 1, xl: 6.5 },
              marginTop: {
                xs: 4, md: 0, lg: 0, xl: 0,
              },
              marginLeft: { xs: 1, lg: 1, xl: 0 },
            }}
          >
            <Indicators
              data={data}
          ...
          <Box
            xs={11}
            sx={{
              backgroundColor: 'primary.main', marginTop: 4, marginLeft: { xs: 1, xl: 6.5 }, marginRight: { xs: 1, xl: 6.5 }, boxShadow: 4, borderRadius: '10px', padding: 2, width: 1,
            }}
          >
            <Description
