    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', color: 'text.secondary' }}>
                ...
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.current_price.eth}</Typography>

                <Typography sx={{ mx: 0.5, fontSize: 10.8 }}>EUR:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.current_price.eur}</Typography>

                <Typography sx={{ mx: 0.5, fontSize: 10.8 }}>USD:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.current_price.usd}</Typography>
            </Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center', color: 'text.secondary' }}>
                ...
                <Typography sx={{ mx: 0.5, fontSize: 10.8 }} >ETH:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.market_cap.eth}</Typography>

                <Typography sx={{ mx: 0.5, fontSize: 10.8 }} >EUR:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.market_cap.eur}</Typography>

                <Typography sx={{ mx: 0.5, fontSize: 10.8 }} >USD:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.market_cap.usd}</Typography>
            </Box>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'baseline', color: 'text.secondary' }}>
                ...
                <Typography sx={{ mx: 0.5, fontSize: 10.8 }}>ETH:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.total_volume.eth}</Typography>

                <Typography sx={{ mx: 0.5, fontSize: 10.8 }}>EUR:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.total_volume.eur}</Typography>

                <Typography sx={{ mx: 0.5, fontSize: 10.8 }}>USD:</Typography>
                <Typography sx={{ fontWeight: 'normal', fontSize: 10.8, color: "secondary.main", fontWeight: 'bold' }}>
                    {data.market_data.total_volume.usd}</Typography>
            </Box>
